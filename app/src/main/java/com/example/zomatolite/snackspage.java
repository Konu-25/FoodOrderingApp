...
public class snackspage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snackspage);
        ...
        cartIcon.setOnClickListener(v -> {
            Intent intent = new Intent(snackspage.this, cartpage.class);
        ...
        addDish1Button.setOnClickListener(v -> addToCart("Crispy Fries", 120));
        addDish2Button.setOnClickListener(v -> addToCart("Veg Burger", 150));
        addDish3Button.setOnClickListener(v -> addToCart("Chicken Burger", 200));
        addDish4Button.setOnClickListener(v -> addToCart("Garlic Bread", 100));
    }
